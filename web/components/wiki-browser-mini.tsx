...
const sequence: Entry[] = [
  ...
  { type: "page", titleWidth: "w-3/5", infoboxRows: 4, delay: 1500 },
  { type: "paragraph", lines: ["w-full", "w-full", "w-full", "w-4/5"], delay: 800 },
  { type: "paragraph", lines: ["w-full", "w-full", "w-3/5"], delay: 1000 },
  { type: "section", width: "w-2/5", delay: 1200 },
  { type: "paragraph", lines: ["w-full", "w-full", "w-3/4"], delay: 900 },
  { type: "image", height: "h-16", color: "bg-amber-100", delay: 800 },
  { type: "paragraph", lines: ["w-full", "w-full", "w-full", "w-1/2"], delay: 1000 },
  { type: "section", width: "w-1/3", delay: 1200 },
  { type: "paragraph", lines: ["w-full", "w-full", "w-2/3"], delay: 900 },
  { type: "image-grid", colors: ["bg-sky-100", "bg-sky-50", "bg-indigo-50", "bg-sky-100"], cols: 2, delay: 800 },
  { type: "paragraph", lines: ["w-full", "w-4/5"], delay: 800 },

  // Page 2 — trip page with photo gallery
  { type: "page", titleWidth: "w-2/5", infoboxRows: 3, delay: 2000 },
  { type: "paragraph", lines: ["w-full", "w-full", "w-full", "w-3/5"], delay: 900 },
  { type: "paragraph", lines: ["w-full", "w-full", "w-1/2"], delay: 800 },
  { type: "section", width: "w-1/2", delay: 1200 },
  { type: "paragraph", lines: ["w-full", "w-full", "w-4/5"], delay: 1000 },
  { type: "image-row", colors: ["bg-emerald-100", "bg-teal-50", "bg-green-100"], delay: 800 },
  { type: "paragraph", lines: ["w-full", "w-3/4"], delay: 800 },
  { type: "section", width: "w-2/5", delay: 1200 },
  { type: "paragraph", lines: ["w-full", "w-full", "w-full", "w-2/3"], delay: 900 },
  { type: "image", height: "h-20", color: "bg-emerald-50", delay: 800 },
  { type: "paragraph", lines: ["w-full", "w-1/2"], delay: 800 },

  // Page 3 — event page
  { type: "page", titleWidth: "w-1/2", infoboxRows: 5, delay: 2000 },
  { type: "paragraph", lines: ["w-full", "w-full", "w-3/4"], delay: 800 },
  { type: "paragraph", lines: ["w-full", "w-full", "w-full", "w-2/5"], delay: 1000 },
  { type: "image", height: "h-14", color: "bg-rose-50", delay: 800 },
  { type: "section", width: "w-1/3", delay: 1200 },
  { type: "paragraph", lines: ["w-full", "w-full", "w-2/3"], delay: 900 },
  { type: "paragraph", lines: ["w-full", "w-full", "w-3/5"], delay: 800 },
  { type: "image-row", colors: ["bg-violet-100", "bg-purple-50"], delay: 800 },
  { type: "section", width: "w-2/5", delay: 1200 },
  { type: "paragraph", lines: ["w-full", "w-4/5"], delay: 900 },
  { type: "image-grid", colors: ["bg-rose-50", "bg-orange-50", "bg-rose-100", "bg-pink-50", "bg-orange-100", "bg-rose-50"], cols: 3, delay: 800 },
  { type: "paragraph", lines: ["w-full", "w-full", "w-1/2"], delay: 800 },
];
